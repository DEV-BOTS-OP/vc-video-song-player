...
async def start(client, message):
    ...
    buttons = [
        [
            ...
            InlineKeyboardButton('🧩 Source', url='https://github.com/Devansh20055/vc-video-song-player')
        ],
        [
...
async def repo_(client, message):
    buttons = [
        [
            InlineKeyboardButton('🧩 Repository', url='https://github.com/Devansh20055/vc-video-song-player'),
            InlineKeyboardButton('⚙️ Update Channel', url='https://t.me/TEAM_SILENT_KING'),     
        ],
        [
